...
export const photos = [
  { src: "/event-invite.jpg", title: "הזמנה לערב בוגרים — רגעים שנשארים בלב", tag: "רגעים שנשארים בלב", year: "2025" },
  { src: "/event-table-set.jpg", title: "השולחן ערוך לכבוד מפגש הבוגרים", tag: "רגעים שנשארים בלב", year: "2025" },
  { src: "/event-gathering1.jpg", title: "בוגרים מסביב לשולחן — חיבור וחברותא", tag: "רגעים שנשארים בלב", year: "2025" },
  { src: "/event-gathering2.jpg", title: "ערב מפגש הבוגרים — רגעים של קהילה", tag: "רגעים שנשארים בלב", year: "2025" },
  { src: "/event-food.jpg", title: "השולחן הגדוש — ליל הסעודה", tag: "רגעים שנשארים בלב", year: "2025" },
