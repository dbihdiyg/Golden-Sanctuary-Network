...
export const pdfs = [
  { title: "עלון קהילת הבוגרים", date: "תשרי תשפ״ו", description: "חדשות, דבר תורה, תמונות וסיפורים מהקהילה.", size: "2.4MB" },
  { title: "סיכום מפגש שנתי", date: "אלול תשפ״ה", description: "סיכום מלא של המפגש, תמונות נבחרות ותודות.", size: "1.8MB" },
  { title: "תכנית חונכות בוגרים", date: "אב תשפ״ה", description: "פרטים להצטרפות כמנטור או כבוגר צעיר בתכנית.", size: "1.1MB" },
  { title: "לוח אירועים ועדכונים", date: "תמוז תשפ״ה", description: "אירועים קרובים, שיעורים, מפגשים ויוזמות.", size: "980KB" },
];
