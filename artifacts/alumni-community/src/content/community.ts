...
export const pdfs = [
  {
    title: "גליון קצ\"ט – אהבת ישראל – אחרי קדושים תשפ\"ו",
    date: "אייר תשפ\"ו",
    description: "פרשת אחרי קדושים: ואהבת לרעך כמוך — כלל גדול בתורה. מהות גיורו של הלל הזקן, אהבה עצמית ואהבת הזולת, ו'ואהבת' שלפני התפילה.",
    size: "PDF",
    url: "/gliyon-199-ahavat-israel-acharei-kedoshim-tashpav.pdf",
  },
  {
