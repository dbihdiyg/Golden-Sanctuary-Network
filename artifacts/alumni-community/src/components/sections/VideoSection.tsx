        ...
        <div className="grid gap-7 md:grid-cols-2">
          {videos.map((video, index) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative min-h-[390px] overflow-hidden rounded-[2rem] border border-white/10 bg-card shadow-[0_30px_90px_rgba(0,0,0,0.45)] transition duration-500 hover:-translate-y-2 hover:border-primary/50 reveal-up"
