      ...
      <div className="relative z-20 mx-auto flex min-h-[100dvh] max-w-7xl flex-col items-center justify-center px-6 pb-24 pt-36 text-center">
        <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a href="/contact" className="rounded-full border border-white/15 bg-white/[0.04] px-8 py-4 text-lg text-white backdrop-blur-xl transition hover:border-blue-brand/60 hover:bg-blue-brand/20 hover:text-primary">
              צור קשר
            </a>
          </div>
